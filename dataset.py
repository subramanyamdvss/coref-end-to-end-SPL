...
class BioMedReader(DatasetReader):
    """
    ...
    def _read(self, file_path: str):
        ...
        bio_reader = Biomed(os.path.join(file_path,"XML"),os.path.join(file_path,"Annotations"))

        for sentences,clusters in bio_reader.dataset_document_iterator():
